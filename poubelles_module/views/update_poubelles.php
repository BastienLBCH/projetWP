...
<div id="poubellesDiv" hidden>
    <form method="POST" id="poubellesForm">
        ...
        <input type="text" id="titre" name="titre" value="<?= $poubelles["titre"] ?>"minlength="4" maxlength="75" size="75">
        <div class="inputAnglais">
        <label  for="titreEn">Choose your title:</label>
        <input  type="text" id="titreEn" value="<?= $poubelles["titreen"] ?>" minlength="4" maxlength="75" size="75">
    </div>
...
<?= $poubelles["descp"] ?>
        ...
        <div class="inputAnglais">
        <textarea id="descpen" name="descp"rows="5" cols="33">
        <?= $poubelles["descpen"] ?>
        </textarea>
    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        poubellesForm.addEventListener("submit", function (e) {
            ...
            // let poubellesTitreEn = document.getElementById("poubellesTitreEn");
...
<?php
    $update_poubelles_view = ob_get_clean();
?>