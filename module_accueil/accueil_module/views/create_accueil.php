...
<a href="<?= $ACTIONS_URL["list"] ?>"> Retour </a>
    ...
    <form id="accueilForm">
        <input type="text" id="accueilTitreFr" placeholder="Titre"> <br>
        <input type="text" id="accueilTitreEn" placeholder="Title"> <br>
        <br>
        <input type="text" id="accueilSousTitreFr" placeholder="Soustitre"> <br>
        <input type="text" id="accueilSousTitreEn" placeholder="subtitle"><br>
        <br>
