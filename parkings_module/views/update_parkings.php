...
<div id="parkingsDiv" hidden>
    <form method="POST" id="parkingsForm">
        ...
        <input type="text" id="titre" name="titre" value="<?= $parkings["titre"] ?>">
        <div class="inputAnglais">
        <label  for="titreEn">Choose your title:</label>
        <input  type="text" id="titreEn" value="<?= $parkings["titreen"] ?>" minlength="4" maxlength="75" size="75">
    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        parkingsForm.addEventListener("submit", function (e) {
            ...
            // Description parkings, ne change pas en fonction de la langue 
...
<?php
    $update_parkings_view = ob_get_clean();
?>