<?php
    ...
    $ACTIONS_URL_parkings = [
        "list" => "http://www.livret-accueil-numerique.fr/parkings/?action_module=list_parkings",
        "create" => "http://www.livret-accueil-numerique.fr/parkings/?action_module=create_parkings",
        "update" => "http://www.livret-accueil-numerique.fr/parkings/?action_module=update_parkings&parkings_id=%d",
        "delete" => "http://www.livret-accueil-numerique.fr/parkings/?action_module=delete_parkings&parkings_id=%d",
        "database" => "http://www.livret-accueil-numerique.fr/wp-content/plugins/parkings_module/models.php"
    ];

    $DEFAULT_URL = $ACTIONS_URL["list"];
    $DEFAULT_ACTION_URL = "list_parkings";
