...
<div id="transportsDiv" hidden>
    <form method="POST" id="transportsForm">
        ...
        <input type="text" id="titre" name="titre" value="<?= $transports["titre"] ?>">

        <div class="inputAnglais">
        <label  for="titreEn">Choose your title:</label>
        <input  type="text" id="titreEn" value="<?= $transports["titreen"] ?>" minlength="4" maxlength="75" size="75">
    </div>
...
<?php
    $update_transports_view = ob_get_clean();
?>